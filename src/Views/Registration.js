                            ...
                            <h3>Enroll in {location.state.course}.</h3>      
                              ...
                              <h3> Register </h3>
                                ...
                                <div className="form-group">
                                    ...
                                    <input required type="password" placeholder="Phone"  className="form-control" name="phone" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.phone} />
                                ...
                                <div className="form-group">
                                    ...
                                    <div>
                                    <select name="time" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.time} >
                                    <option >Morning</option>
                                    <option >Evening</option>
                                    </select>
                                    </div>
                                  {formik.errors.time && formik.touched.time ? (<div className='error' style ={{color:'red'}}>{formik.errors.time}</div>) : null}
                                </div>
                                <div className="form-group">
                                    <label>Your Education Level *</label>
                                    <input required type="education" placeholder="Confirm Password"  className="form-control" name="education" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.education} />
